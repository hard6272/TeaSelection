...
/**
 Base class for all TeaSelection views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the TeaSelection view hierarchy (such as wrapped iOS UIViews) was touched.
