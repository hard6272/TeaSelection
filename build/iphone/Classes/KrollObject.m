...
//@interface TeaSelectionObject : NSObject
//@end

@interface TeaSelectionObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TeaSelectionObject class]])
		{
			for (NSString *key in [[(TeaSelectionObject*)o modules] allKeys])
			{
