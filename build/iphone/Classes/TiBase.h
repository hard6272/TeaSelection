...
// in simulator we redefine to format for TeaSelection Developer console
...
{\
	NSString * exceptionName = [@"org.teaselection." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.teaselection";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITeaSelectionNativeItemNone = -1, 
	UITeaSelectionNativeItemSpinner = -2,
	UITeaSelectionNativeItemProgressBar = -3,
	
	UITeaSelectionNativeItemSlider = -4,
	UITeaSelectionNativeItemSwitch = -5,
	UITeaSelectionNativeItemMultiButton = -6,
	UITeaSelectionNativeItemSegmented = -7,
	
	UITeaSelectionNativeItemTextView = -8,
	UITeaSelectionNativeItemTextField = -9,
	UITeaSelectionNativeItemSearchBar = -10,
	
	UITeaSelectionNativeItemPicker = -11,
	UITeaSelectionNativeItemDatePicker = -12,
	
	UITeaSelectionNativeItemInfoLight = -13,
	UITeaSelectionNativeItemInfoDark = -14,
	
	UITeaSelectionNativeItemDisclosure = -15,
	
	UITeaSelectionNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TeaSelection instances of
