...
@interface TeaSelectionObject : KrollCoverageObject {
#else
@interface TeaSelectionObject : KrollObject {
#endif
@private
...
extern NSString * TeaSelection$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	TeaSelectionObject *_teaselection;
    KrollObject* console;
	BOOL shutdown;
