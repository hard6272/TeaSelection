...
//Rare exceptions to indicate a bug in the _teaselection code (Eg, function that a subclass should have implemented)
...
/**
 The base class for TeaSelection proxies.
 */
